...
test("必須機能とレスポンシブ設計をソースに備える", async () => {
  ...
  assert.doesNotMatch(app, /emailRedirectTo: getTodoAuthRedirectUrl/);
